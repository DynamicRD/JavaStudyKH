...
//		Stream <String> stream3 =Arrays.stream(name).filter(t->t.startsWith("C")).sorted((String o1, String o2)->o1.compareTo(o2));
		//4.Stream을 종단처리(배열이나, 컬렉션프레임워크로 변경)
		List<String> list2 = Arrays.stream(name).filter(t->t.startsWith("C")).sorted((String o1, String o2)->o1.compareTo(o2)).collect(Collectors.toList());
