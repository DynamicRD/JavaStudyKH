...
public class AiCar implements InterfaceCar {
	...
	@Override
	public void start() {
		System.out.println("자율 자동차가 출발합니다.");
	}
	...
	@Override
	public void stop() {
		System.out.println("자율 자동차가 정지합니다.");
	...
	public int setSpeed(int speed) {
		this.speed = speed;
		System.out.println("자동차가 속도를 자율로"+speed+"km/h로 바꿉니다");
		return speed;
	}

	@Override
	public int turn(int degree) {
		System.out.println("자동차가 방향을 자율로"+degree+"km/h로 바꿉니다");
		return 0;
	}
